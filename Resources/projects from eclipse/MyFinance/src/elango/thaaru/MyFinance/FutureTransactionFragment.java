...
public class FutureTransactionFragment extends Fragment
{
	...
	public View onCreateView(LayoutInflater layoutInflater,
		...
		mInflatedView = layoutInflater.inflate(R.layout.future_transaction_fragment, container,
				false);
		setGlobalVariables();
        setTodayDate();
    					...
    					implements DatePickerDialog.OnDateSetListener 
    {
		...
		public void onDateSet(DatePicker view, int year, int month, int day) 
		{
			...
			{
				Toast toast = Toast.makeText(getActivity(),R.string.err_date_past_not_allowed,Toast.LENGTH_SHORT);
				toast.setGravity(Gravity.CENTER,0,0);
				toast.show();
				return;
			}
