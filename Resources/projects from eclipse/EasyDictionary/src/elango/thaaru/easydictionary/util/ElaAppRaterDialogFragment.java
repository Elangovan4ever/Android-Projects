...
import elango.thaaru.easydictionary.R;
		...
		try {
			...
			btnNeverAsk.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					try {
						G.log("start");
						SharedPreferences prefs = mRateAppView.getContext().getSharedPreferences("easydictapp", 0);
			...
			btnRateNow.setOnClickListener(new View.OnClickListener() {
				/*********************************************************************************
				 * Redirect to the dictionary application in google play store to rate it
				 *********************************************************************************/
				@Override
				public void onClick(View v) {
					try {
