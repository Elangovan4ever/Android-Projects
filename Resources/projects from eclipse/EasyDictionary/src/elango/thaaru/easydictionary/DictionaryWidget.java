...
public class DictionaryWidget extends AppWidgetProvider {
	...
	public void cancelAlarm(Context context, int appWidgetId) {
		try{
		G.log("start");
		Intent intent = new Intent(context, DicitionaryWidgetService.class);
	...
	public void onDisabled(Context context) {
		try{
		G.log("start");
		context.stopService(new Intent(context, DicitionaryWidgetService.class));
	...
	public void onReceive(Context context, Intent intent) {
		...
		if ("android.intent.action.BOOT_COMPLETED".equals(intent.getAction())) {
			...
			int[] allWidgetIds = appWidgetManager.getAppWidgetIds(
					new ComponentName(context, DictionaryWidget.class));
			for (int widgetId : allWidgetIds) {
				...
				DictionaryWidgetConfActivity dictionaryWidgetConfActivity = new DictionaryWidgetConfActivity();
