...
import elango.thaaru.easydictionary.util.ElaInputFilterMinMax;
import elango.thaaru.easydictionary.util.G;

public class DictionaryWidgetConfActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		try {
			...
			setContentView(R.layout.dictionary_widget_configuration);
	...
	public void startAlarmAndService(Context context, int widgetId, long timeIntervalInMillisecs) {
		try {
			G.log("start");
			Intent dictionaryServiceIntent = new Intent(context, DicitionaryWidgetService.class);
			...
			okbutton.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					try {
						...
						final Context context = DictionaryWidgetConfActivity.this;
