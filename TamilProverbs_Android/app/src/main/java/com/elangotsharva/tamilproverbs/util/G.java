...
public class G {
	public static final String L = "TamilProverbs";
	public static final String TABLE_TAMILPROVERB = "tamilproverb";
	public static final String COLUMN_ID = "_id";
	public static final String COLUMN_PROVERB = "proverb";
	...
	public static Typeface tfBamini;
	public static Typeface tfTscii;
	public static Typeface tfAnjal;
	public static Typeface tfTab;
	public static Typeface tfTam;
